...
public class CsvAuthoritativeItemImporterTest extends AbstractImporterTest {

    private static final Logger logger = LoggerFactory.getLogger(CsvAuthoritativeItemImporterTest.class);
