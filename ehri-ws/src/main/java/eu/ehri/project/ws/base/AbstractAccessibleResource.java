...
public class AbstractAccessibleResource<E extends Accessible> extends AbstractResource {
    ...
    public Response listItems() {
        try (final Tx tx = beginTx()) {
            checkUser();
            Response page = streamingPage(() -> getQuery().page(cls));
            tx.success();
            return page;
        }
    }
    ...
    protected <T extends Entity> Response streamingXmlZip(Supplier<XmlExporter<T>> exporter, Supplier<Iterable<T>> items, String lang) {
